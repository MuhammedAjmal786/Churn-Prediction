...
# User input fields
CreditScore = st.number_input("Credit Score", min_value=300, max_value=850, value=500)
...
EstimatedSalary = st.number_input("Estimated Salary", min_value=0, max_value=200000, value=100000)
# Add more input fields as necessary based on the model's features
...
if st.button("Predict"):
    ...
    input_data = pd.DataFrame({
        ...
        'Geography': [0 if geography == "France" else 1 if geography == "Spain" else 2],
